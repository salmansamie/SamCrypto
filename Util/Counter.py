...
An example of usage is the following:
    ...
    >>> from SamCrypto.Cipher import AES
    >>> from SamCrypto.Util import Counter
    >>>
    >>> pt = b'\x00'*1000000
    >>> ctr = Counter.new(128)
...
if sys.version_info[0] == 2 and sys.version_info[1] == 1:
    from SamCrypto.Util.py21compat import *
from SamCrypto.Util.py3compat import *

from SamCrypto.Util import _counter
import struct
